...
class ArbitratorNode(Node):
    ...
    def _tick(self):
        ...
        if self._obstacle:
            # Only do autonomous avoidance if the user was actively driving.
            # If the joystick is idle, just hold still rather than auto-rotate.
            if self._is_stale(self._manual_stamp) or self._is_stale(self._auto_stamp):
